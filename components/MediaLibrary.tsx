                ...
                <div className="container mx-auto px-4">
                    <header className="relative z-10">
                        ...
                        <div className="flex items-center gap-2 flex-wrap my-4">
                            <button className={`tab is-active`}>{t('media.tab.videos')}</button>
